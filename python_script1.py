...
for i in l:
    ...
    df2=df2.drop(['_id','Paper Code','Paper Title','Department','Semester'],axis=1)
...
for data in x:
    ...
    name=data["Paper title and code"]
    sem=data["Semester"]
...
data = [
    ["Name of the program:", program+ " " + department, "Semester:", sem,], # 'testing','size'],
    ["Subject Name", Paper_name, "Subject Code", Paper_code], 
    ["Maximum Marks:", "20", "Time Duration:", "2 Hrs",], 
